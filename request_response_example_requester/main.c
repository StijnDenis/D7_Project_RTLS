...
static uint8_t send_channel[2] = {0x04, 0x08};
static uint8_t tx = 0;
static uint8_t counter = 0;
static volatile bool add_tx_event = false;
static volatile bool wait_for_response = false;
static volatile bool instr_send = false;

uint8_t buffer[128];

static volatile uint8_t dataLength = 0;

static volatile int uart_ptr = 0;
static uint8_t uart_instr[3];
...
void load_instruction(char instr)
{

	uart_instr[uart_ptr] = instr;
...
//#pragma vector=ADC12_VECTOR,RTC_VECTOR,AES_VECTOR,COMP_B_VECTOR,DMA_VECTOR,PORT1_VECTOR,PORT2_VECTOR,SYSNMI_VECTOR,UNMI_VECTOR,USCI_B0_VECTOR,WDT_VECTOR,TIMER0_A0_VECTOR,TIMER1_A1_VECTOR
